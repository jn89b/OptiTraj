...
class Plane(CasadiModel):    
    ...
    def define_state_space(self) -> None:
        ...
        self.v_dot = ca.sqrt(self.x_fdot**2 + self.y_fdot**2 + self.z_fdot**2) #* self.airspeed_tau
        #self.psi_fdot   = self.u_psi + (self.g * (ca.tan(self.phi_f) / self.v_cmd)) #* self.pitch_tau
